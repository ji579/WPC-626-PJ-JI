...
function loadExhibitionData(exhibitIndex = 0) {
  ...
  if (!imgtxt4Element || !imgbx3Element) {
    console.log('지우기처리!');
    if (!imgbx3Element) modalBoxDiv[2].style.display = "none";
    if (!imgtxt4Element) modalBoxDiv[3].style.display = "none";
    modalBoxDiv[4].style.opacity = "1";
  } else {
    if (imgtxt4Element) {
    ...
    modalBoxDiv[2].style.display = "block";
    modalBoxDiv[3].style.display = "block";
  }
